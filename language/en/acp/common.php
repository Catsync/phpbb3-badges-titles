...
$lang = array_merge($lang, array(
	...
	'LOG_BADGE_UPDATED'		=> '<strong>Badge details updated</strong><br />» %s',
	'LOG_TITLE_UPDATED'		=> '<strong>Title details updated</strong><br />» %s',
	'LOG_BADGE_CREATED'		=> '<strong>New badge created</strong><br />» %s',
	'LOG_TITLE_CREATED'		=> '<strong>New title created</strong><br />» %s',
	'LOG_BADGE_DELETE'		=> '<strong>Badge deleted</strong><br />» %s',
	'LOG_TITLE_DELETE'		=> '<strong>Title deleted</strong><br />» %s',
	'LOG_BADGE_USERS_ADDED'	=> '<strong>Awarded badge to users</strong> %1$s<br />» %2$s',
	'LOG_TITLE_USERS_ADDED'	=> '<strong>Awarded title to users</strong> %1$s<br />» %2$s',
	'LOG_BADGES_USER_ADDED'	=> '<strong>Awarded badges to user</strong> %1$s<br />» %2$s',
	'LOG_BADGE_REMOVE'		=> '<strong>Removed badge from users</strong> %1$s<br />» %2$s',
	'LOG_TITLE_REMOVE'		=> '<strong>Removed title from users</strong> %1$s<br />» %2$s',
	'LOG_BADGES_REMOVE'		=> '<strong>Removed badges from user</strong> %1$s<br />» %2$s',
